module.exports = function () {
    return {
        ...
        , products: [
            ...
            { id: 8, name: "Human Chess Board", category: "Chess", description: "A fun gaem for the family", price: 75},
            { id: 9, name: "Bling Bling King", category: "Chess", description: "Gold-plated, dlamond-studded King", price: 1200}
        ],
        orders: []
    }
}